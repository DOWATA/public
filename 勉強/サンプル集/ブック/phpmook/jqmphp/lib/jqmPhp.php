...
//define('JQMPHP_JQ', 'http://code.jquery.com/jquery-1.9.1.min.js', true);
...
//define('JQMPHP_JQM', 'http://code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.min.js', true);
...
//define('JQMPHP_CSS', 'http://code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.min.css', true);
